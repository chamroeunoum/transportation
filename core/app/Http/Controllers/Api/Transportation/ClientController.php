...
use App\Models\Client AS RecordModel;
...
class ClientController extends Controller
{
    ...
    public function index(Request $request){
        $crud = new CrudController( new RecordModel, $request , [ 'id', 'firstname', 'lastname' , 'phone', 'address', 'email', 'photo' ,"created_at" ,"updated_at" ,"deleted_at" ]);
